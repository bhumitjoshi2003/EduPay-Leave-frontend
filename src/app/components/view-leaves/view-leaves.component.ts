import { Component, OnInit, OnDestroy } from '@angular/core';
 ...
 export class ViewLeavesComponent implements OnInit, OnDestroy {
   ...
   selectedDate: any = ''; // Allow null or empty string for no date selected
   private ngUnsubscribe = new Subject<void>();

   constructor(private leaveService: LeaveService, private studentService: StudentService, private authService: AuthService, private teacherService: TeacherService) { }
   ...
   sortAndFilterLeaves(): void {
     this.filteredLeaves = this.allLeaves.sort((a, b) => {
       ...
       return dateB.getTime() - dateA.getTime(); // Sort by future date (descending)
     }).filter((leave) => {
